            ...
            try {
                ...
                if (data.success && data.data) {
                    ...
                    if (data.data.length > 0) {
                        ...
                        console.log(
                            "Possible causes type:",
                            typeof data.data[0].possibleFeverCauses
                        );
                        console.log(
                            "Possible causes value:",
                            data.data[0].possibleFeverCauses
                        );
                    }
                    ...
                    if (!data.success && data.message !== "No records found") {
                        toast.error(
                            data.message || "Failed to load past records"
                        );
                    }
                }
            } catch (error) {
            ...
            <motion.div
                ...
                <div className="text-center py-8">
                    ...
                    <p className="text-light-secondary-text dark:text-dark-secondary-text">
                        No past records found. Use the Check Health feature to
        ...
        <motion.div
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-light-secondary-text dark:text-dark-secondary-text">
                        Your health check history ({records.length} record
                        {records.length !== 1 ? "s" : ""})
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-4">
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        ...
                                        {record.urgentCareAlert && (
                                            <div className="w-fit flex items-center gap-2 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded">
                            ...
                            <AnimatePresence>
                                {expandedRecord === record.id && (
                                    <motion.div
                                        ...
                                        className="border-t-3 border-light-secondary dark:border-dark-secondary">
                                        <div className="p-4 space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    {Array.isArray(
                                                        ...
                                                        <ul className="list-disc list-inside space-y-1">
                                                            {record.possibleFeverCauses.map(
                                                                (
                                                                    cause,
                                                                    idx
                                                                ) => (
                                                                    <li
                                                                        ...
                                                                        className="text-sm text-light-secondary-text dark:text-dark-secondary-text">
                                                                        {typeof cause ===
                                                                        "object"
                                                                            ? Object.values(
                                                                                  cause
                                            ...
                                            {record.redFlagsToWatchFor && (
                                                <div className="bg-light-fail/20 dark:bg-dark-fail/20 px-4 p-3 rounded-md">
                ...
                {records.length >= 2 && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-fit mx-auto py-3 px-6 text-light-secondary dark:text-dark-secondary rounded-lg font-semibold hover:bg-light-secondary/10 dark:hover:bg-dark-secondary/10 transition-colors flex items-center justify-center gap-2">
                        {showAll ? (
                            <>

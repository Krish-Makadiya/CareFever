        ...
        const fetchContacts = async () => {
            ...
            try {
                const response = await fetch(
                    ...
                    }/api/user/${userId}/emergency-contacts`
                );
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                toast.error(
                    data.message || "Failed to save emergency contacts"
                );
            }
        } catch (error) {
                    ...
                    <div>
                        ...
                        <p className="text-sm text-light-secondary-text dark:text-dark-secondary-text">
                            {!isEditing && hasContacts
                                ...
                                : "Add 1-4 emergency contacts who can be reached in case of emergency"}
                        </p>
                    </div>
                </div>
                {!isEditing && hasContacts && (
            ...
            {!isEditing && hasContacts ? (
                ...
                <div className="space-y-4">
                    {contacts.map((contact, index) => (
                        <div
                            key={index}
                            className="p-4 bg-light-bg dark:bg-dark-bg rounded-lg">
                ...
                <div className="space-y-6">
                    {contacts.map((contact, index) => (
                        <div
                            key={index}
                            className="p-4 bg-light-bg dark:bg-dark-bg rounded-lg space-y-4">
